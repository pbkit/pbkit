...
// Source: pbkit/interface-pingpong-server/less_repeated_scalar.proto
//
...
extension Pbkit_Pingpong_LessRepeatedScalar: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
