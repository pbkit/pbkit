// @deno-types="https://esm.sh/vscode-jsonrpc@8.0.0-next.6/lib/common/messages.d.ts?pin=v103"
import {
  ErrorCodes,
  Message,
  NotificationMessage,
  RequestMessage,
  ResponseMessage,
} from "https://esm.sh/vscode-jsonrpc@8.0.0-next.6/lib/common/messages.js?pin=v103";
